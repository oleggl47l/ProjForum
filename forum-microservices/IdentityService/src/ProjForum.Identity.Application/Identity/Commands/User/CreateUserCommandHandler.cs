...
public class CreateUserCommandHandler(
    ...
    RoleManager<ProjForum.Identity.Domain.Entities.Role> roleManager) : IRequestHandler<CreateUserCommand, Unit>
{
    public async Task<Unit> Handle(CreateUserCommand request, CancellationToken cancellationToken)
    {
        var user = new ProjForum.Identity.Domain.Entities.User
        {
    ...
    private async Task<List<ProjForum.Identity.Domain.Entities.Role>> GetRolesByNames(IEnumerable<string> roleNames)
    {
        var roles = new List<ProjForum.Identity.Domain.Entities.Role>();
    ...
    private async Task AddRolesToUserAsync(ProjForum.Identity.Domain.Entities.User user,
