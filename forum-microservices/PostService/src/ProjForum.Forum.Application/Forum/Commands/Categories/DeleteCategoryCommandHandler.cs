...
public class DeleteCategoryCommandHandler(ICategoryRepository categoryRepository, IPostRepository postRepository) : IRequestHandler<DeleteCategoryCommand, Unit>
{
