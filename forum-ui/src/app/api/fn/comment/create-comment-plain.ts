...
export function createComment$Plain(http: HttpClient, rootUrl: string, params?: CreateComment$Plain$Params, context?: HttpContext): Observable<StrictHttpResponse<Unit>> {
...
createComment$Plain.PATH = '/api/forum/v1/Comment/CreateComment';
