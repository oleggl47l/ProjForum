...
export function createCategory$Plain(http: HttpClient, rootUrl: string, params?: CreateCategory$Plain$Params, context?: HttpContext): Observable<StrictHttpResponse<Unit>> {
